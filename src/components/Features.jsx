      ...
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          ...
          <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-80">
            ...
            corporis delectus. Tenetur aliquid natus eaque iusto quisquam
            dolorum quos quas corporis nisi repellat recusandae consectetur in,
            aut hic repudiandae velit?
          </p>
        </div>
